...
NN_CONFIG_FILE = str(SCRIPT_DIR / "./models/hand-yolo-tiny.json")
OBJECT_DETECTION_MODEL = str(SCRIPT_DIR / "./models/hand_yolo_v4_tiny_openvino_2021.3_4shave.blob")
...
class daiPipeline:
    ...
    def resetPipeline(self, face_det=True, face_rec=False, hand_det=False, hand_landmarks=False, obj_det=False, frameHeight=1000):
        self.pipeline_running = False
    ...
    def next_frame(self):
        ...
        return frame, depth_frame, self.facerec_result, self.hands, self.obj_det_result
